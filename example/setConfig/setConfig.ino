 ...
 * @n INA238_I2C_ADDRESS4  0x45   A0 = 1  A1 = 1	 
  */
INA238_IIC     ina238(&Wire, INA238_I2C_ADDRESS4);
...
void setup(void) 
{
    ...
    while(ina238.begin() != true) {
        ...
        ina238.setBADC(ina238.eIna238_conversion_time_540);       
        ina238.setSADC(ina238.eIna238_conversion_time_540);       
        ina238.setSAMPLE(ina238.eIna238AdcSample_4);
        ina238.setADCRange(ina238.eIna238AdcRange_0);
        ina238.setMode(ina238.eIna238SBVolCon);
